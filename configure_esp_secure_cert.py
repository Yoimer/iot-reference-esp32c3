...
supported_key_size = {'esp32':[1024, 2048, 3072, 4096],'esp32s2':[1024, 2048, 3072, 4096], 'esp32c3':[1024, 2048, 3072], 'esp32s3':[1024, 2048, 3072, 4096]}
...
ciphertext_size = {'esp32':1600,'esp32s2':1600,'esp32s3':1600,'esp32c3':1216}
...
def main():
    ...
    parser.add_argument(
        '--target_chip',
        dest='target_chip', type=str, choices={'esp32','esp32s2', 'esp32s3', 'esp32c3'},
        default='esp32c3',
        metavar='target chip',
        help='The target chip e.g. esp32, esp32s2, s3, c3')
